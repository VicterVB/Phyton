class Teller:
    ...
    def __add__(self, other):
        if isinstance(other, Teller):
            return Teller(self.data + other.data)
        else:
            return NotImplemented

    def __radd__(self, other):
        # Implementeer __radd__ om commutatieve optelling te ondersteunen
...
class LijstTeller(Teller):
    def plus(self, value):
        if isinstance(value, list):
            ...
            print("Onverwacht type voor plus-methode van LijstTeller")
...
class DictTeller(Teller):
    def plus(self, value):
        if isinstance(value, dict):
            ...
            print("Onverwacht type voor plus-methode van DictTeller")
